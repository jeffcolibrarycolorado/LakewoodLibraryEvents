  ...
  if (xmlDoc) {
    ...
    for (var i=0;i<x.length;i++) {
      ...
      if (branch == localbranch) {
        ...
        if (x[i].getElementsByTagNameNS("http://bibliocommons.com/rss/1.0/modules/event/","end_date")[0]
            && x[i].getElementsByTagNameNS("http://bibliocommons.com/rss/1.0/modules/event/","end_date")[0].childNodes[0]) {
        ...
        if (x[i].getElementsByTagNameNS("http://bibliocommons.com/rss/1.0/modules/event/","is_cancelled")[0] 
            && x[i].getElementsByTagNameNS("http://bibliocommons.com/rss/1.0/modules/event/","is_cancelled")[0].childNodes[0] 
            && x[i].getElementsByTagNameNS("http://bibliocommons.com/rss/1.0/modules/event/","is_cancelled")[0].childNodes[0].nodeValue == "true") {
          continue;
        }

        // Is the event full?
        if (x[i].getElementsByTagNameNS("http://bibliocommons.com/rss/1.0/modules/event/","is_full")[0] 
            && x[i].getElementsByTagNameNS("http://bibliocommons.com/rss/1.0/modules/event/","is_full")[0].childNodes[0] 
